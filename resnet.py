...
RESNET101_WEIGHT_PATH_NO_TOP = "resnet101_weights_tf_dim_ordering_tf_kernels_notop.h5"
...
def ResNet(
    ...
    if weights == "imagenet":
        if include_top:
            ...
            weights_path = RESNET101_WEIGHT_PATH_NO_TOP
...
def stack_residual_blocks_v1(x, filters, blocks, stride1=2, name=None, attention_module=None):
...
def ResNet101(
    ...
    def stack_fn(x):
        x = stack_residual_blocks_v1(x, 64, 3, stride1=1, name="conv2", attention_module=attention_module)
        x = stack_residual_blocks_v1(x, 128, 4, name="conv3", attention_module=attention_module)
        x = stack_residual_blocks_v1(x, 256, 23, name="conv4", attention_module=attention_module)
        return stack_residual_blocks_v1(x, 512, 3, name="conv5", attention_module=attention_module)
