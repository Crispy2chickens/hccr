...
DENSENET121_WEIGHT_PATH_NO_TOP = "pre-weights/densenet121_weights_tf_dim_ordering_tf_kernels_notop.h5"

def dense_block(x, blocks, name, attention_module=None):
    """A dense block.
...
def DenseNet(
    ...
    x = dense_block(x, blocks[0], name="conv2", attention_module=attention_module)
    x = transition_block(x, 0.5, name="pool2")
    x = dense_block(x, blocks[1], name="conv3", attention_module=attention_module)
    x = transition_block(x, 0.5, name="pool3")
    x = dense_block(x, blocks[2], name="conv4", attention_module=attention_module)
    x = transition_block(x, 0.5, name="pool4")
    x = dense_block(x, blocks[3], name="conv5", attention_module=attention_module)
